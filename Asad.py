...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await idk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await ydk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await wdk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await hdk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await sdk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await adk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await bdk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
...
# Rocks Project By Asad Ali & Harshit Sharma
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await cdk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await ddk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Shayri_Music_Lovers"))
            await edk(functions.channels.JoinChannelRequest(channel="@AsadSupport"))
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀\n\n𝙐𝙩𝙞𝙡𝙨 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.ping\n.restart\n\n𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.bio\n.join\n.pjoin\n.leave\n\n𝙎𝙥𝙖𝙢 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\n**Fᴏʀ ᴍᴏʀᴇ ʜᴇʟᴘ ʀᴇɢᴀʀᴅɪɴɢ ᴜsᴀɢᴇ ᴏғ ᴘʟᴜɢɪɴ ᴛʏᴘᴇ ᴘʟᴜɢɪɴ ɴᴀᴍᴇ ᴏʀ ᴄᴏɴᴛᴀᴄᴛ @Dr_Asad_Ali 👉...**"
       await e.reply(text, parse_mode=None, link_preview=None )
...
print(text)
print("")
print("**Rᴏᴄᴋs sᴘᴀᴍ ʙᴏᴛ sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ...😜**")
